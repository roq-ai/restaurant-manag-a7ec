  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the Power of Efficiency with Restaurant Management System: Streamlining Menu Creation, Enhancing Searchability, and Empowering Admin Control for Ultimate Dining Experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTY3NDIwNjh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the Power of Efficiency with Restaurant Management System: Streamlining Menu Creation, Enhancing Searchability, and Empowering Admin Control for Ultimate Dining Experience.`}
            </Text>
            <Box
