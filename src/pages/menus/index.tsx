...
export function MenuListPage(props: MenuListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMenus({
        relations: ['restaurant', 'dish_category.count', 'menu_dish_category.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['description.contains', 'name.contains', 'image.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('dish_category', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.dish_category,
        }
      : null,
