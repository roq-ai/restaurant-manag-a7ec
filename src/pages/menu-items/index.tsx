...
export function MenuItemListPage(props: MenuItemListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMenuItems({
        relations: [, 'dish_category_menu_item.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: [
          'dish_description.contains',
          'dish_image_url.contains',
          'dish_ingredients.contains',
          'dish_name.contains',
          'dish_allergens.contains',
        ],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'dish_description', header: 'Dish Description', accessorKey: 'dish_description' },
    { id: 'dish_image_url', header: 'Dish Image Url', accessorKey: 'dish_image_url' },
    { id: 'dish_price', header: 'Dish Price', accessorKey: 'dish_price' },
    { id: 'dish_calories', header: 'dish_calories', accessorKey: 'dish_calories' },
    { id: 'dish_ingredients', header: 'Dish Ingredients', accessorKey: 'dish_ingredients' },
    { id: 'dish_preparation_time', header: 'dish_preparation_time', accessorKey: 'dish_preparation_time' },
    { id: 'dish_name', header: 'Dish Name', accessorKey: 'dish_name' },
    { id: 'dish_allergens', header: 'Dish Allergens', accessorKey: 'dish_allergens' },
    { id: 'dish_spiciness_level', header: 'dish_spiciness_level', accessorKey: 'dish_spiciness_level' },
    { id: 'dish_vegan', header: 'Dish Vegan', accessorKey: 'dish_vegan' },
    { id: 'dish_gluten_free', header: 'Dish Gluten Free', accessorKey: 'dish_gluten_free' },
