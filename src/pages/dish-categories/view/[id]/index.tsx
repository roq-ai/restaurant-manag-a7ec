...
import { getDishCategoryById } from 'apiSdk/dish-categories';
...
import { MenuDishCategoryListPage } from 'pages/menu-dish-categories';

function DishCategoryViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('dish_category', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/dish-categories/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Dish Category Image" text={data?.dish_category_image} />

                <FormListItem label="Dish Category Status" text={data?.dish_category_status} />

                <FormListItem label="Dish Category Color" text={data?.dish_category_color} />
