...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by Customer John Doe.create': {
    roles: ['restaurant-owner', 'restaurant-manager', 'kitchen-staff'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Order #123 has been updated by Kitchen Staff Jane Doe.update': {
    roles: ['restaurant-owner', 'restaurant-manager'],
    key: 'order_update',
    tenantPath: [],
    userPath: [],
  },
  'Feedback has been received from Customer John Doe.create': {
    roles: ['restaurant-owner', 'restaurant-manager'],
    key: 'feedback_create',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['restaurant-owner', 'restaurant-manager', 'kitchen-staff', 'customer'];
