...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['restaurant-manager', 'restaurant-owner', 'kitchen-staff', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Dish Category Menu Items',
      path: '/dish-category-menu-items',
    ...
    {
      name: 'Menu Dish Categories',
      path: '/menu-dish-categories',
